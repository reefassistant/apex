...
// OutlogContainer struct for OutlogContainer
type OutlogContainer struct {
	...
	Record   []OutlogRecord `json:"record"`
}
...
func (o OutlogContainer) MarshalJSON() ([]byte, error) {
...
type NullableOutlogContainer struct {
	value *OutlogContainer
	isSet bool
}

func (v NullableOutlogContainer) Get() *OutlogContainer {
	return v.value
}

func (v *NullableOutlogContainer) Set(val *OutlogContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableOutlogContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableOutlogContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOutlogContainer(val *OutlogContainer) *NullableOutlogContainer {
	return &NullableOutlogContainer{value: val, isSet: true}
}

func (v NullableOutlogContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOutlogContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
